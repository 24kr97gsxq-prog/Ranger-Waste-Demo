...
**Last updated: Tuesday, August 18, 2026 — v4. Replaces v3.1.**
Update the date whenever you change something.

**Status:** Demo feature-complete at **Build v0.10.1**, live at
24kr97gsxq-prog.github.io/Ranger-Waste-Demo/ (own repo, verified separate from
DivertScan). No backend exists. Nothing is in front of Ranger yet.
